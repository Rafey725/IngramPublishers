      ...
      <div className="max-w-195 md:w-[clamp(20rem,50vw,48.75rem)] py-6">
        ...
        <ul className='space-y-4'>
          {secondSectionList.map((item, index) => {
            return (
              <li key={index} className='text-[clamp(1rem,2.5vw,1rem)] text-[#3c3c3c] mb-10 ' >{item}</li>)
          })}
        </ul>
      </div>
    </div >
