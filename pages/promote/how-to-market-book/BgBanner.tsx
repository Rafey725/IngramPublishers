...
const BgBanner = (props: BgBannerProps) => {
    return (
        <div
            id={props.id}
            className={`w-full bg-[#f6f8fa] max-h-screen min-h-[40vh] h-full lg:h-[45vh] flex mb-5`}>
            <div className="content max-w-[1150px] mx-auto w-full h-full flex flex-col-reverse justify-center lg:flex-row lg:justify-between items-center px-5 py-10">
