...
const Step1 = () => {
    return (
        <div id='step-one' className="max-w-195 md:w-[clamp(20rem,50vw,48.75rem)] py-6">
            {/* Step 1: Writing */}
            <div className="mb-5">
            ...
            <div className="rounded-lg relative w-full h-[15.625rem] sm:h-[18.75rem] md:h-[21.875rem] lg:h-[25rem]
">
